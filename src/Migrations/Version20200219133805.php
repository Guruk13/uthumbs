 ...
 */
final class Version20200219133805 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE waiting_user ADD accept_walker TINYINT(1) NOT NULL, ADD accept_driver TINYINT(1) NOT NULL, ADD driver_name VARCHAR(255)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE waiting_user DROP accept_walker, DROP accept_driver, DROP driver_name');
    }
}
